...
# ============================================
# FUNÇÕES PARA GERAÇÃO DE PLANOS DE ENSINO
# ============================================
...
<head>
<meta charset="UTF-8">
<title>PLANO DE ENSINO - {disciplina}</title>
...
.validacao-digital-box::before {{
    content: "VALIDAÇÃO DIGITAL";
    display: block;
    font-weight: bold;
    font-size: 5pt;
    margin-bottom: 1mm;
    border-bottom: 0.3pt solid #1a237e;
    padding-bottom: 1mm;
}}
...
/* BOX DE DADOS PESSOAIS ESTENDIDOS - COM ENQUADRAMENTO CURRICULAR */
.box-dados-pessoais {{
    border: 1pt solid #1a237e;
    margin: 8mm 0;
    padding: 5mm;
...
.box-dados-pessoais::before {{
    content: "IDENTIFICAÇÃO DA DISCIPLINA";
    position: absolute;
    top: -3mm;
    left: 5mm;
    background: #fff;
...
.dado-valor-historico-enquadramento {{
    font-weight: bold;
    color: #000;
    font-size: 9pt;
    line-height: 1.4;
...
/* TABELA DE DISCIPLINAS - ADAPTADA PARA CONTEÚDO */
.tabela-disciplinas {{
    width: 100%;
    border-collapse: collapse;
    margin: 8mm 0;
...
.box-avaliacao3::before {{
    content: "EMENTA EXPANDIDA";
    position: absolute;
    top: -3mm;
    left: 5mm;
    background: #f9f9f9;
...
.btn:hover {{ background: #0d1245; }}

@media print {{
    .botoes {{ display: none; }}
}}

/* ESTILOS ESPECÍFICOS DO PLANO */
.ementa-lista {{
    text-align: justify;
    line-height: 1.6;
    color: #1a1a1a;
...
.conteudo-programatico strong {{
    ...
    margin-top: 8px;
    margin-bottom: 4px;
    border-bottom: 0.5pt solid #1a237e;
    padding-bottom: 2px;
}}
...
<div class="folha">
    ...
    <div class="cabecalho">
        <div class="logo-area">
            ...
            <div class="instituicao-info">
                <div class="instituicao-nome">FACOP/SiGEU</div>
                <div class="instituicao-sub">Faculdade do Centro Oeste Paulista 04.344.730/0001-60<br> FACOP Manetedora | Grupo Educacional Unificado LTDA </div>
                <div class="instituicao-sub"> IES e-mec 19325 via Portaria nº 887 de 2017 </div>
            </div>
        </div>
        <div class="selo-autenticidade">
            <div>VALIDADO</div>
    ...
    <!-- TÍTULO DO DOCUMENTO -->
    <div class="titulo-documento">
        <div class="titulo-principal">PLANO DE ENSINO</div>
        <div class="titulo-sub">{disciplina}</div>
    </div>
    
    <!-- BOX DE IDENTIFICAÇÃO COM ENQUADRAMENTO CURRICULAR -->
    <div class="box-dados-pessoais">
        <div class="dados-grid">
            <div class="dado-item-historico">
                <div class="dado-label-historico">Disciplina</div>
                <div class="dado-valor-historico">{disciplina}</div>
            </div>
            <div class="dado-item-historico">
                <div class="dado-label-historico">Departamento</div>
                <div class="dado-valor-historico">ENGENHARIA AMBIENTAL E SANITÁRIA</div>
            </div>
            <div class="dado-item-historico">
                <div class="dado-label-historico">Carga Horária</div>
                <div class="dado-valor-historico">{carga_horaria}</div>
            </div>
            <div class="dado-item-historico">
                <div class="dado-label-historico">Modalidade</div>
                <div class="dado-valor-historico">{modalidade}</div>
            </div>
        </div>
        
        <!-- LINHA COM PRÉ-REQUISITOS E ENQUADRAMENTO CURRICULAR LADO A LADO -->
        <div class="dados-grid-enquadramento">
            <div class="dado-item-historico">
                <div class="dado-label-historico">Pré-requisitos</div>
                <div class="dado-valor-historico">Não há pré-requisitos formais para esta disciplina.</div>
            </div>
            <div class="dado-item-historico">
                <div class="dado-label-historico">Enquadramento Curricular</div>
                <div class="dado-valor-historico-enquadramento">{enquadramento_curricular}</div>
            </div>
        </div>
    </div>
    
    <!-- OBJETIVO GERAL -->
    <div class="box-avaliacao box-avaliacao8">
        <div class="objetivo-texto">{objetivo_geral}</div>
    </div>
    
    <!-- OBJETIVOS ESPECÍFICOS -->
    <div class="box-avaliacao box-avaliacao9">
        <div class="objetivos-lista">
            <div class="objetivo-item">{objetivos_especificos}</div>
        </div>
    </div>
    
    <!-- EMENTA -->
    <div class="box-avaliacao box-avaliacao3">
        <div class="ementa-lista">{ementa}</div>
    </div>
...
<div class="folha">
    ...
    <!-- TÍTULO -->
    <div class="titulo-documento">
        <div class="titulo-principal">CONTEÚDO</div>
        <div class="titulo-sub">PROGRAMÁTICO E HABILIDADES</div>
    </div>
    
    <!-- CONTEÚDO PROGRAMÁTICO -->
    <div class="box-avaliacao box-avaliacao4">
        <div class="conteudo-programatico">{conteudo_programatico}</div>
    </div>
    
    <!-- HABILIDADES -->
    <div class="box-avaliacao box-avaliacao5">
...
<div class="folha">
    ...
    <!-- TÍTULO -->
    <div class="titulo-documento">
        <div class="titulo-principal">METODOLOGIA</div>
        <div class="titulo-sub">AVALIAÇÃO E BIBLIOGRAFIA</div>
    </div>
    
    <!-- METODOLOGIA -->
    <div class="box-avaliacao box-avaliacao2">
        {METODOLOGIA_FIXA}
    </div>
...
<div class="folha">
    ...
    <div class="box-avaliacao box-avaliacao7">
        {bibliografia_complementar}
    </div>
